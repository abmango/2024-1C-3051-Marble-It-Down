...
namespace TGC.MonoGame.TP.Stages.Items
{
    ...
    {
        public Ruby(GraphicsDevice graphicsDevice, ContentManager content, Color color, float size, Vector3 coordinates, Vector3 scale, Matrix rotation) : base(graphicsDevice, content, color, size, coordinates, scale, rotation)
        {
        ...
        {
            return new DiamondPrimitive(graphicsDevice, content, color, size, coordinates, scale, rotation);
        }
